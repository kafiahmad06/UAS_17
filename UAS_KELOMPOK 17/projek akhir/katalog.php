...
// Jika properti berhasil dihapus, tampilkan alert
...
<nav class="bg-gray-300 shadow-lg sticky top-0 z-50">
  <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
    ...
    <div id="nav-menu" class="hidden md:flex space-x-6 items-center font-bold">
      ...
      <a href="katalog.php" class="hover:text-blue-500">Katalog</a>
      <a href="pesanan.php" class="text-white bg-blue-600 px-4 py-2 rounded hover:bg-blue-700">Data Pesanan</a>
    </div>
  </div>
  <div id="mobile-menu" class="md:hidden hidden px-4 pb-4">
    <a href="halaman.php" class="block py-2">Home</a>
    <a href="katalog.php" class="block py-2">Katalog</a>
    <a href="pesanan.php" class="block py-2">Data pesanan</a>
  </div>
</nav>
...
<section id="katalog" class="py-16 px-6 md:px-20">
  <div class="flex justify-between items-center mb-8">
    <h2 class="text-3xl font-bold">Katalog Properti</h2>
    <a href="tambahproperti.php" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">+ Tambah Properti</a>
  </div>
      ...
      <div class="min-w-[250px] bg-white rounded-lg shadow-md overflow-hidden hover:scale-90 duration-500">
        ...
        <div class="p-4">
          ...
          <div class="mt-3 flex gap-2">
            <a href="editproperty.php?id=' . $r['id'] . '" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm">Edit</a>
            <a href="hapusproperty.php?id=' . $r['id'] . '" onclick="return confirm(\'Yakin ingin menghapus properti ini?\')" class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded text-sm">Hapus</a>
          </div>
        </div>
      </div>';
    }
    ...
    while ($a = mysqli_fetch_assoc($apartemen)) {
      ...
      <div class="min-w-[250px] bg-white rounded-lg shadow-md overflow-hidden hover:scale-90 duration-500">
        ...
        <div class="p-4">
          ...
          <p class="text-blue-600 font-bold">' . $hargaTampil . '</p>
          <div class="mt-3 flex gap-2">
            <a href="editproperty.php?id=' . $a['id'] . '" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-sm">Edit</a>
            <a href="hapusproperty.php?id=' . $a['id'] . '" onclick="return confirm(\'Yakin ingin menghapus properti ini?\')" class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded text-sm">Hapus</a>
          </div>
        </div>
      </div>';
    }
